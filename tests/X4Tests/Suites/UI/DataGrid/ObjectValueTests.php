...
final class ObjectValueTests extends X4TestCase
{
    public function test_methodName() : void
    {
        ...
        $col = $this->ui
            ...
            ->configObject()->setMethodName('getLabel')->done();
    ...
    public function test_propertyName() : void
    {
        ...
        $col = $this->ui
            ->createDataGrid()
            ->addColumn('default', 'Default')
            ->configObject()->setPropertyName('publicProperty')->done();
    ...
    public function test_accessor() : void
    {
        ...
        $col = $this->ui
            ->createDataGrid()
            ->addColumn('default', 'Default')
            ->configObject()->setAccessor(static function(TestObject $object) : int {
